...
static const char qt_meta_stringdata_ChatDialog[] = {
    "ChatDialog\0\0handleReturnPressed()\0"
    "processPendingDatagrams()\0"
    "configureAntiEntropy()\0destAddr,destPort\0"
    "sendACKDatagram(QHostAddress*,quint16*)\0"
};
...
void ChatDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->handleReturnPressed(); break;
        case 1: _t->processPendingDatagrams(); break;
        case 2: _t->configureAntiEntropy(); break;
        case 3: _t->sendACKDatagram((*reinterpret_cast< QHostAddress*(*)>(_a[1])),(*reinterpret_cast< quint16*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
